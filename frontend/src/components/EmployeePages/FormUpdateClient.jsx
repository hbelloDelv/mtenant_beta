...
const FormUpdateClient = () => {
  ...
  // To retrieve, I am sending the company id and token
    ...
    <Grid2 sx={{ display: "flex", justifyContent: "center" }}>
      <Paper elevation={10} style={paperStyle}>
        ...
        <TextField
          ...
          name="plotId"
          disabled={!formData.plotId} // Disable if plotId is null or empty
        />
        <FormControl fullWidth sx={{ mb: "1rem" }}>
          ...
          <Select
            ...
            required
            displayEmpty
            disabled={!formData.landStatus} // Disable if landStatus is null or empty
          >
